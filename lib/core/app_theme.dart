  ...
  static ThemeData get dark {
    ...
    return base.copyWith(
      ...
      textTheme: GoogleFonts.dmSansTextTheme(base.textTheme).copyWith(
        ...
        bodyLarge: GoogleFonts.dmSans(fontSize: 16, color: darkOnSurface),
        bodyMedium: GoogleFonts.dmSans(fontSize: 14, color: darkOnSurface),
        bodySmall: GoogleFonts.dmSans(fontSize: 12, color: darkMuted),
        labelLarge: GoogleFonts.dmSans(
          fontSize: 14,
          fontWeight: FontWeight.w700,
          color: darkOnSurface,
        ),
        labelSmall: GoogleFonts.dmSans(fontSize: 11, color: darkMuted),
      ),
      ...
      dialogTheme: DialogThemeData(
        ...
        contentTextStyle: GoogleFonts.dmSans(color: darkMuted, fontSize: 14),
